...
+ (DaiIndoxWindow *)hudWindow {
    if (!objc_getAssociatedObject(self, _cmd)) {
        ...
        DaiIndoxWindow *newWindow = [[DaiIndoxWindow alloc] initWithFrame:CGRectMake(X, Y, W, H)];
...
+ (DaiInboxHUD *)shared {
    ...
    dispatch_once(&onceToken, ^{
        ...
        sharedHUD.colors = @[[UIColor orangeColor], [UIColor orangeColor], [UIColor orangeColor], [UIColor orangeColor]];
